...
namespace CasinoApp.Shared
{
    ...
    public sealed class OperationResult<T>
    {
        ...
        public CasinoAppValidationResult ValidationResult { get; private set; }
        ...
        private OperationResult(T data, OperationResultType resultType, string message, string stackTrace, CasinoAppValidationResult validationResult)
        {
            this.Data = data;
        ...
        /// <returns></returns>
        [SuppressMessage(SuppressMessageConstants.DesignCategory, SuppressMessageConstants.DoNotDeclareStaticMembersOnGenericTypes)]
        public static OperationResult<T> CreateFailureResult(CasinoAppValidationResult validationResult)
        {
